...
const Individualmarketss = () => {
  ...
  return (
    <div className="container mt-2">
            ...
            <div className="row">
              {Object.entries({
                ...
                <div className="col-md-6 mb-2" key={key}>
                  <h6 className="card-subtitle mb-1 text-muted fw-medium">{key}</h6>
      ...
      {
        department === 'Employee' && markets.status?.name === 'completed' && <span className='text-danger fw-medium'>* Enter comment describing the purpose of reopening the ticket before requesting reopen</span>
      }
      <ToastContainer />
    </div>
